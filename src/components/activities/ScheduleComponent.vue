<template>
  <div class="schedule-page">
    ...
    <div class="filters-container">
      ...
      <button @click="openActivityModal('', '')" class="add-activity-btn">
        ...
        >
          ...
          >
            <div 
              ...
              @click.stop="editActivity(getActivity(day.key, time))"
            >
        ...
        <form @submit.prevent="saveActivity" class="activity-form">
          ...
          <div class="form-row">
            ...
            <div class="form-group">
              ...
              <select v-model="currentActivity.duration" required>
          ...
          <div class="modal-actions">
            ...
            <button v-if="isEditing" type="button" @click="deleteActivity" class="delete-btn">
...
export default {
      ...
      activities: {
        monday: {
          '09:00': {
            ...
            duration: '30min',
            type: 'recreation',
            description: 'Accueil des enfants avec jeux libres'
          },
          '10:00': {
            id: 2,
            ...
            duration: '45min',
            type: 'education',
            description: 'Apprentissage des lettres et des chiffres'
          }
        },
        tuesday: {
          '10:30': {
            ...
            duration: '45min',
            type: 'sport',
            description: 'Exercices de motricité globale'
          }
        }
      }
    };
  ...
  methods: {
    ...
    saveActivity() {
      ...
      const activityData = {
        id: this.currentActivity.id || Date.now(),
        title: this.currentActivity.title,
        group: this.currentActivity.group,
        duration: this.currentActivity.duration + 'min',
        type: this.currentActivity.type,
        description: this.currentActivity.description
      };
      
      this.activities[this.currentActivity.day][this.currentActivity.time] = activityData;
      this.closeModal();
      console.log('Activité sauvegardée:', activityData);
    },
    
    deleteActivity() {
      if (this.activities[this.currentActivity.day] && this.activities[this.currentActivity.day][this.currentActivity.time]) {
        delete this.activities[this.currentActivity.day][this.currentActivity.time];
      }
      this.closeModal();
    }
  }
