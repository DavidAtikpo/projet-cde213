<template>
  <div class="activity-creator-page">
    <div class="header">
      ...
      <p>Planifiez et organisez de nouvelles activités éducatives</p>
    </div>
        ...
        <form @submit.prevent="createActivity" class="activity-form">
          ...
          <div class="form-section">
            ...
            <div class="form-row">
              ...
              <div class="form-group" v-if="activity.recurrence !== 'none'">
      ...
      <div class="preview-container">
        ...
        <div class="activity-preview">
          <div class="preview-card">
            ...
            <div class="activity-skills" v-if="activity.skills.length > 0">
              <h5>Compétences développées :</h5>
              <div class="skills-tags">
                <span 
                  v-for="skillId in activity.skills" 
                  :key="skillId"
                  class="skill-tag"
                >
